			...
			<div class="page-content">
				...
				<!--div class="portlet light ">
                    ...
                    <div class="portlet box blue no_shadow">
                        ...
                        <div class="portlet-body grey-l padding_c">
							...
							<div class="portlet forum gren no-bpadding ">
								<div class="portlet-title">
									...
									<div class="caption">
										...
										<span class="caption-subject">forum1</span>
										<span style="display:inline-block; width: 600px;"></span>
										<span class="caption-helper">views:  <b>333</b></span>
										<span style="display:inline-block; width: 100px;"></span>
										<span class="caption-helper">threds:  <b>333</b></span>
								...
								<div class="portlet-body list grey-light">
									<div class=" no-padding" >
										<div class="table-responsive noo-margin">
											<table class="table table-hover table-striped boardless ">
												<tbody >
												<tr>
													<td>
														<a href="javascript:;">
							...
							<div class="portlet forum gren no-bpadding ">
								...
								<div class="portlet-body list display-hide">
									<div class=" no-padding" >
										<div class="table-responsive noo-margin">
					...
					<div class="portlet-body list">
						...
						<div class="portlet forum gren noo-margin no-bpadding">
							<div class="portlet-title">
							...
							<div class="portlet-body list grey-steel">
								<div class=" no-padding" >
									<div class="table-responsive noo-margin">
										<table class="table table-hover  table-light">
											<tbody >
						...
						<div class="portlet forum gren noo-margin ">
							<div class="portlet-title">
